...
public class CertificadoDigitalController {
	...
	public ResponseEntity<CertificadoDigital> alterar(@PathVariable Long id,@RequestBody CertificadoDigital certificadodigital) {
		...
		auto.setNomeProduto(certificadodigital.getNomeProduto());
		auto.setTipoPublico(certificadodigital.getTipoPublico());
		auto.setValidade(certificadodigital.getValidade());
		auto.setPreco(certificadodigital.getPreco());
		auto.setAtivo(certificadodigital.isAtivo());
		auto.setValidadeMeses(certificadodigital.getValidadeMeses());
